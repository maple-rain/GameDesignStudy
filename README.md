...
| 문서 | 기간 | 결론 |
|---|---|---|
| [로스트아크 재련 SWOT](./SystemAnalysis/LostArk_Refining_SWOT.md) | 2025-02 ~ 05 | **두 성장 경로의 효율 격차 최대 11배**, 1660 구간의 **투자 회수 기간 55~138주**. 원본 발표자료 데이터 이미지 3장 포함. 10개월 뒤 실제 패치와 대조 검증 |
| [젠레스 존 제로 성장 곡선](./SystemAnalysis/ZZZ_GrowthCurve.md) | 2026-01 | 이 게임은 플레이 시간이 아니라 **경과 일수로 성장을 통제**한다. 상시 콘텐츠를 전부 소진하면 **정확히 41레벨 문턱**에 선다. 59→60레벨에 70일 |
