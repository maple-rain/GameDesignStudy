...
| 문서 | 기간 | 결론 |
|---|---|---|
| [로스트아크 재련 SWOT](./SystemAnalysis/LostArk_Refining_SWOT.md) | 2025-02 ~ 05 | 일반 재련은 비용 14배에 딜증 고정, 상급 재련은 비용 1.8배에 딜증 1.5배. **두 성장 경로의 효율 격차 최대 11배**. 10개월 뒤 실제 패치와 대조 검증 포함 |
