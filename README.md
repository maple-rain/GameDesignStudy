...
| **분석했다** | 게임 20개 · 설계 개념 6개 · 서비스와 경제 6개 |
...
| [GameAnalysis/](./GameAnalysis) | **메커닉** | 게임 하나를 10단계 템플릿으로 분석 — 20개 |
...
| [TIL/](./TIL) | 날짜별 학습 기록 20개 + [개념 목록과 판단이 바뀐 기록](./TIL/LearnedConcepts.md) |
...
- [x] GameAnalysis 13개 문서를 10단계 템플릿으로 통일 (이후 Disco Elysium · Hades · 완다와 거상 · Devil May Cry 5 · Shadow Tactics · Katana ZERO · Monster Hunter: World 추가로 20개)
